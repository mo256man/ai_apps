...
def draw_graph(ax1, ax2, line_temp, line_humi, dt_list, temp_list, humi_list):
    print(f"re-draw! {dt_list[-1]} {temp_list[-1]} {humi_list[-1]}")
    ax1.set_xlim(dt_list[0], dt_list[-1]+datetime.timedelta(minutes=1))
    ax2.set_xlim(dt_list[0], dt_list[-1]+datetime.timedelta(minutes=1))
...
def main():
    ...
    ax1.set_xlim(dt_list[0], dt_list[-1])
    ax2.set_xlim(dt_list[0], dt_list[-1])
    line_temp, = ax1.plot(dt_list, temp_list, marker="o")
    line_humi, = ax2.plot(dt_list, humi_list, marker="*")
    ...
    draw_graph(ax1, ax2, line_temp, line_humi, dt_list, temp_list, humi_list)
    plt.draw()
    plt.pause(1)    
